...
3. Images work fine. My strategy for org-mode is to create a separate
   ...
   publishing images.
4. You can embed Markdown (or other Octopress/Jekyll directives) by embedding
   inside of a =#+begin_html= and =#+end_html= block.
   [[file:/2013-04-27-octopress-setup-with-github-and-org-mode/quoting-markdown-in-org-mode.png]]
