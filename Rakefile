...
# I'd like to move this to it's own file
# But this did not pick up the definitions at the top of this file
...
# Not yet tested
# http://blog.chatswood.org.uk/blog/2012/10/21/working-with-drafts-in-octopress/
require "preamble"
