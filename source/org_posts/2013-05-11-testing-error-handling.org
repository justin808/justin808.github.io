...
[[file:../blog/2013/05/08/strategies-for-rails-logging-and-error-handling/][Strategies for Rails Logging and Error Handling]] discussed some techniques to
...
See my prior article [[file:../blog/2013/05/08/saner-rails-logging/][Saner Rails Logging]] for the answers to #2 and #3.
...
1. There's a block to catch the exception which is /separate from the
   ...
   that all the right things happen with this sort of error (see [[file:../blog/2013/05/08/saner-rails-logging/][code for
   Utlity.logException]]).
...
Related Post:
[[file:../blog/2013/05/08/strategies-for-rails-logging-and-error-handling/][Strategies
